Profile:     CdrTemperaturaCorporalRectal
Parent:      CdrSignosVitales
Id:          CdrTemperaturaCorporalRectal
Title:       "Temperatura Corporal Rectal"
Description: "Este recurso permite guardar la información de la temperatura corporal de los pacientes tomada desde la zona rectal."
* ^language = #es
...
* code.text ^example.valueString = "TEMPERATURA RECTAL"
...
Instance:    TemperaturaCorporalRectalExample
InstanceOf:  CdrTemperaturaCorporalRectal
Usage:       #Example
Title:       "Temperatura Corporal Rectal"
Description: "Ejemplo de la temperatura corporal de un paciente tomado desde la zona rectal."

* status = #final
* category[VSCat] = http://terminology.hl7.org/CodeSystem/observation-category#vital-signs
* code.coding =  $loinc#8332-9 "Rectal temperature"
* code.text = "TEMPERATURA RECTAL"
