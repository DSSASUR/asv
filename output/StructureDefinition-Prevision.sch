...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'prevision']) &gt;= 1">extension with URL = 'prevision': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'prevision']) &lt;= 1">extension with URL = 'prevision': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'tramoisapre']) &lt;= 1">extension with URL = 'tramoisapre': maximum cardinality of 'extension' is 1</sch:assert>
